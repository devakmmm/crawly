...
public class ImageFinderTest {
	...
	public void test() throws IOException, ServletException {
		...
		// Verify that a response was generated (either images or error)
		// Since we're mocking the request, we can't actually crawl, but we can verify
		// the servlet handles the request without throwing exceptions
